...
ステップ2: 氷結ブロックの隣で同色(赤)のブロックが消去されたため、氷結とカウンターが同時に解除されて通常ブロックになる
    a b c
  ┌─────┐
0 │   _R _B│  _R: 赤の通常ブロック (氷結カウンターが解除されて通常ブロックに)
1 │   _B _B│  _B: 青の通常ブロック
2 │_Y _Y _G│  _Y: 黄の通常ブロック
  └─────┘  _G: 緑の通常ブロック
2 │_Y _Y _G│  _Y: 黄の通常ブロック
...
ステップ3: 新たに赤ブロックが隣接位置に配置され、消去可能なグループを形成
    a b c
  ┌─────┐
0 │_R _R _B│  _R: 赤の通常ブロック
1 │_R _B _B│  _B: 青の通常ブロック
2 │_Y _Y _G│  _Y: 黄の通常ブロック
  └─────┘  _G: 緑の通常ブロック

ステップ4: 3つの赤ブロックを選択して消去（通常の消去ルールで）
    a b c
  ┌─────┐
0 │      _B│
1 │   _B _B│
...
ステップ2: 氷結ブロックの隣で同色(赤)のブロックが消去されたため、氷結とカウンター+が同時に解除されて通常ブロックになる
    a b c
  ┌─────┐
0 │   _R _B│  _R: 赤の通常ブロック (氷結カウンター+が解除されて通常ブロックに)
1 │   _B _B│  _B: 青の通常ブロック
2 │_Y _Y _G│  _Y: 黄の通常ブロック
  └─────┘  _G: 緑の通常ブロック
...
0 │_R _R _B│  _R: 赤の通常ブロック
1 │_R _B _B│  _B: 青の通常ブロック
2 │_R _Y _G│  _Y: 黄の通常ブロック
  └─────┘  _G: 緑の通常ブロック

ステップ4: 4つの赤ブロックを選択して消去（通常の消去ルールで）
    a b c
  ┌─────┐
0 │      _B│
1 │   _B _B│
