...
ステップ3: 位置(2,0)と(1,1)と(2,1)の青ブロックを消去し、氷結ブロックが落下
    0 1 2
  ┌─────┐
0 │       │  
...
ステップ4: 位置(1,2)の赤ブロックを消去し、氷結が解除されて通常ブロックになり落下
    0 1 2
  ┌─────┐
0 │       │  
1 │       │  
...
ケース1: 位置(0,0)と(0,1)と(1,0)の赤ブロック3つを選択（ちょうど3つ）
    0 1 2
  ┌─────┐
0 │_R ①R _B│  選択した赤ブロック3つ（カウンターブロック含む）
...
ケース2: 位置(0,0)と(1,0)の赤ブロック2つを選択（3より少ない）
    0 1 2
  ┌─────┐
0 │_R ①R _B│  選択した赤ブロック2つ
1 │_R _B _B│  カウンター値=3より少ないため消去不可
2 │_Y _Y _G│
  └─────┘
...
ケース1: 位置(0,0)と(0,1)と(1,0)の赤ブロック3つを選択（ちょうど3つ）
    0 1 2
  ┌─────┐
0 │_R ⊕R _B│  選択した赤ブロック3つ（カウンター+ブロック含む）
...
ケース2: 位置(0,0)と(1,0)の赤ブロック2つを選択（3より少ない）
  ...
  ┌─────┐
0 │_R ⊕R _B│  選択した赤ブロック2つ
1 │_R _B _B│  カウンター値=3+より少ないため消去不可
2 │_Y _Y _G│
  └─────┘
...
初期状態:
  ...
  ┌─────┐
0 │_R ⓵R _B│  _R: 赤の通常ブロック
1 │_R _B _B│  ⓵R: 赤の氷結カウンターブロック(値=3)
2 │_Y _Y _G│  _B: 青の通常ブロック
  └─────┘  _Y: 黄の通常ブロック
             _G: 緑の通常ブロック
...
初期状態:
  ...
  ┌─────┐
0 │_R ⊛R _B│  _R: 赤の通常ブロック
1 │_R _B _B│  ⊛R: 赤の氷結カウンター+ブロック(値=3+)
2 │_Y _Y _G│  _B: 青の通常ブロック
  └─────┘  _Y: 黄の通常ブロック
             _G: 緑の通常ブロック
